...
ansii = {'r': '\001\033[31m\002', 'g': '\001\033[32m\002', 'b': '\001\033[34m\002', '_': '\001\033[0m\002'}
...
def test_code(debug=False):
    while True:
        ...
        except Exception as e: print(ansii['r'] + str(print_traceback(src, result, silent=True) if debug else e) + ansii['_'])
